class BillingController < ApplicationController
  ...
  def subscribe
      ...
      if plan_id == User::ADMIN_PLAN_ID
        current_user.update_attributes(role: "admin")
      elsif plan_id == User::EDITOR_PLAN_ID
        current_user.update_attributes(role: "editor")
      else
        current_user.update_attributes(role: "normal")
      end
